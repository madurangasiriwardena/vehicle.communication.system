...
public class Signature implements Serializable {
	...
	public Signature(ECPoint E0, ECPoint E1, ECPoint E2, BigInteger ACOM,
			BigInteger BCOM, BigInteger c, BigInteger Tx, BigInteger Ts,
			BigInteger TePrime, BigInteger Tt, BigInteger TE, Integer index) {
		this.E0 = E0;
		this.E1 = E1;
		this.E2 = E2;
		this.ACOM = ACOM;
